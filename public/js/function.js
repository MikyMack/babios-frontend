(function ($) {
	...
	if ($('.hero-slider-metal').length) {
		const hero_slider_metal = new Swiper('.hero-slider-metal', {
			slidesPerView : 1,
			speed: 1000,
			loop: true,
			autoplay: {
    ...
    const floatWrap = document.querySelector(".babios-float-wrap");

    window.addEventListener("scroll", () => {
        if (window.scrollY > 150) {
            floatWrap.classList.add("active");
        } else {
